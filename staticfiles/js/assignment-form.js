...
/**
 * Initialize keyboard shortcuts and date picker
 */
document.addEventListener('DOMContentLoaded', function() {
    // Initialize Flatpickr for better date/time picker
    ...
    if (dueDateInput) {
        flatpickr(dueDateInput, {
            ...
            onReady: function(selectedDates, dateStr, instance) {
                // Agregar íconos y mejor estilo
                instance.calendarContainer.classList.add('flatpickr-custom');
            },
            onChange: function(selectedDates, dateStr, instance) {
                // Actualizar el input oculto con el formato correcto
