...
"""
    ...
    def generate_feedback(self, transcription_result, coherence_score, participation_data, liveness_result, coherence_results=[], max_score=20.0):
        """
...
"""
        ...
        if coherence_results:
            ...
            for idx, resultado in enumerate(coherence_results_sorted, 1):
                ...
                max_score_individual = resultado.get('max_score', max_score)
                
                feedback += f"""**{idx}. {icon} {resultado['etiqueta']}** - {resultado['nivel']}
   📝 Calificación: **{resultado['calificacion_final']}/{max_score_individual}**
...
"""
   ...
   • Calificación promedio: {promedio_calificacion:.1f}/{max_score}
