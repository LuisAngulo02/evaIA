...
class CoherenceAnalyzer:
    ...
    def _calcular_calificaciones_finales(self, resultados, max_score=20.0):
        ...
        for resultado in resultados:
            ...
            # UMBRALES FIJOS para clasificación de nivel (NO afectados por rigurosidad)
            # La rigurosidad afecta la calificación numérica, pero los niveles son estándar
            nota_para_nivel = resultado['nota_coherencia']
            
            # Clasificación con umbrales fijos
            if nota_para_nivel >= 90:
                resultado['nivel'] = "Excelente"
            elif nota_para_nivel >= 80:
                resultado['nivel'] = "Muy Buena"
            elif nota_para_nivel >= 70:
                resultado['nivel'] = "Buena"
            elif nota_para_nivel >= 60:
                resultado['nivel'] = "Regular"
            elif nota_para_nivel >= 50:
