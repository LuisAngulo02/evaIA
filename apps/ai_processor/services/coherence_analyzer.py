...
class CoherenceAnalyzer:
    ...
    def generar_conclusion_grupal(self, resultados_participantes, tema, descripcion_tema):
        """
        ...
        try:
            ...
            for idx, r in enumerate(resultados_participantes, 1):
                info_participantes.append(
                    f"{idx}. {r['etiqueta']}: {r['calificacion_final']:.1f}/20 pts "
...
- Calificación promedio: {calificacion_promedio:.1f}/20
