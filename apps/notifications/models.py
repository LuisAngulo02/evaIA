...
class Notification(models.Model):
    ...
    NOTIFICATION_TYPES = [
        ...
        ('NEW_SUBMISSION', 'Nueva presentación enviada'),
        ('SUBMISSION_READY_TO_GRADE', 'Presentación lista para calificar'),
        ('ASSIGNMENT_DEADLINE_APPROACHING', 'Fecha límite de asignación próxima'),
    ]
